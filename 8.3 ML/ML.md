...
5. 模型参数自动调优
6. 0.NLP算法工具
7. 0.RASA开源机器学习框架，实现基于文本和语音的对话自动化
8. 0.RocketQA，用于信息检索和问题回答的密集检索，包括中文和英文的最先进模型。
9. 0.haystack开源的NLP框架
10. 0.分词
11. 1.1 智能标注-主动学习
12. 1.信息抽取（关键词抽取）
13. 2.文本分类
...
34. 数学建模
35. 特征筛选方法
36. [水豚桌面 – 免费 AI 桌面工作台，智能分类桌面应用与文件](#weekly-item-53-item-35339bdfc6) <!-- ai-compass-weekly-highlight-sync:route weekly_report_20260824_1112.md::item-35339bdfc6 -->
...
<!-- ai-compass-weekly-highlight-sync:start weekly_report_20260824_1112.md::item-35339bdfc6 -->
<a id="weekly-item-53-item-35339bdfc6"></a>
------------------------------------------------------------

## 水豚桌面 – 免费 AI 桌面工作台，智能分类桌面应用与文件

> 周报归档：第 53 期 · 条目 item-35339bdfc6 · 2026-08-24 · [回看原周报](../weeklyHighlights/53.md#item-35339bdfc6)
...
<!-- ai-compass-weekly-highlight-sync:end weekly_report_20260824_1112.md::item-35339bdfc6 -->
