...
4. 1.1 paddleNLP模型库
5. ERNIE模型
6. 1.2 paddle API(蒸馏，数据增强等)
7. 2. ERNIE
8. 2.1 ERNIE-Tiny
9. 2.2 ERNIE-Doc
10. 2.0 ERNIEKIT-文心模型
11. 2.3 Ernie工具提效(网格搜索、数据增强)
12. 3. UIE
13. 3.1 text to knowledge解语
14. 分词
15. 4.Paddlehub
16. 5.数据集（千言、百度）
17. 5.1 基准数据集【clue、glue】
18. 6.智能标注
19. Label Studio
20. 飞桨标注文档（分类、信息抽取）
21. PaddleLabel飞桨智能标注(图像)
22. doccona标注
23. 7.百度智能云-AI开发平台 BML
24. BML-IDE
25. 云上飞桨（PaddleCloud）
26. 8.VisualDL
