...
**分类**：AI 模型 API 服务 / 开发者工具

**简介**：CoderPlan 是 OpenAI 兼容的 AI 模型 API 中转站，为国内开发者提供 Claude / GPT-5.5 / Gemini 3.1 Pro / DeepSeek V3+R1 等主流大模型的统一接入服务。

**核心特性**：

- 完全兼容 OpenAI SDK，只需修改 `base_url`，零代码改动。
- 国内直连，无需科学上网。
- 支持 Claude Code / Cursor / Cline / Continue 等主流 AI 编程工具。
- 按量付费，官方约 0.7 折。
- 支持支付宝 / 微信支付，¥10 起充。
- 新用户注册送体验余额。

**API 端点**：`https://api.coderplan.ai/v1`（作为 OpenAI SDK 的 `base_url` 使用）

## 免费资源 / AI 工具导航

### [白嫖 BaiPiao](https://baipiao.org/)

**分类**：免费资源 / AI 工具导航

**图标**：[`https://baipiao.org/favicon.png`](https://baipiao.org/favicon.png)

**简介**：白嫖 BaiPiao 是 AI 白嫖资源聚合站，收录免费 API 额度、AI 编程工具、免费算力、镜像中转站，并提供订阅比价与公益站导航。所有资源持续核实有效性，死活由社区投票裁决，不做付费排名。
